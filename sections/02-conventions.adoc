...
consensus we chosed to use the term
...
OpenTimestamps::
An open source software acting as aggregation and calendar server to timestamp
on the Bitcoin Distributed Ledger <<OTS>>.
